...
const cors = require("cors");                                       // Importa el módulo 'cors' para agregar los cors
const express = require("express");                                 // Importa el módulo 'express' para crear la aplicacion web
const morgan = require("morgan");                                   // Importa morgan para ver las peticiones que se hacen al servidor
const cookieParser = require("cookie-parser");                      // Importa el módulo 'cookie-parser' para manejar las cookies
/** El enrutador principal */
const indexRoutes = require("./routes/index.routes.js");
const { setupDB } = require("./config/configDB.js");                // Importa el archivo 'configDB.js' para crear la conexión a la base de datos
